...
if (Test-Path -Path $netdrive){
   ...
   Compress-Archive -path "D:\Sage_50_Data_copy\*" `
   ...
   -from "Thunderbird Sage Daily Backup <printer@atomiccartoons.com>" -to "Minh Tran <mtran@atomiccartoons.com>", "Robert Crowther <rcrowther@atomiccartoons.com>" `
